...
var updateRegion = async(region)=>{
    y = await fetch('http://ec2-34-230-4-251.compute-1.amazonaws.com:8080/wargame/updateregion', {
        method: "PUT",
...
var addPlayer = async()=>{
     y = await fetch('http://ec2-34-230-4-251.compute-1.amazonaws.com:8080/wargame/putplayer', {
        method: "PUT",
...
var getPlayers = async()=>{
    x = await fetch('http://ec2-34-230-4-251.compute-1.amazonaws.com:8080/wargame/getplayers', {
        mode: 'no-cors',
        method: 'GET',
        headers: {
...
var updateAllRegions = async()=>{
    y = await fetch('http://ec2-34-230-4-251.compute-1.amazonaws.com:8080/wargame/updateallregion', {
        method: "PUT",
